...
sudo cp arch/arm64/boot/dts/freescale/fsl-ls1043a-*.dtb /mnt/t80usb/boot/
sudo cp arch/arm64/boot/Image /mnt/t80usb/boot/
...
echo ""
echo "--- Contents of /mnt/t80usb/boot/ ---"
ls -l /mnt/t80usb/boot/
echo "---"
echo ""
